        ...
        <div className="dex-details">
            ...
            {selectedDex && (
                <div className="dex-details-info">
                    <p><strong>Name:</strong> {selectedDex?.name}</p>
                    <p><strong>Liquidity Type:</strong> {selectedDex?.liquidity_type}</p>
                    <p><strong>Liquidity:</strong> {selectedDex?.liquidity}</p>
                    <p><strong>Pair:</strong> {selectedDex?.pair}</p>
                </div>
            )}
        </div>
    );
